...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_latest_freq', type=int, default=2000, help='frequency of saving the latest checkpoints')
        ...
        self.parser.add_argument('--lambda_tv', type=float, default=0, help='weights for total_variation_regularization')
