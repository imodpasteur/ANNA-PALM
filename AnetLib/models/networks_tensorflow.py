...
def create_unet_model(inputs, targets, controls, channel_masks, ngf=64, ndf=64, output_uncertainty=False, bayesian_dropout=False, use_resize_conv=False,
    ...
    if use_squirrel:
        ...
        _squirrel_train, _squirrel_output_fetches = generate_squirrel_model(lr_inputs, outputs, targets, lr_scale=lr_scale, ndf=ndf//8, lr=lr, beta1=beta1, dropout_prob=dropout_prob, lr_loss_mode=lr_loss_mode)
...
def build_network(model_type, input_size, input_nc, output_nc, batch_size, use_resize_conv=False, include_summary=True,
    ...
    if model_type == 'a_net':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim_l1', use_punet=True, control_nc=control_nc, control_classes=control_classes, use_gaussd=use_gaussd, lr_nc=lr_nc, lr_scale=lr_scale, use_squirrel=True, lr_loss_mode=lr_loss_mode, squirrel_weight=squirrel_weight)
    elif model_type == 'unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv)
    elif model_type == 'punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_punet=True, control_nc=control_nc, control_classes=control_classes)
    elif model_type == 'ssim_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim=True)
    elif model_type == 'ssim_punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim=True, use_punet=True, control_nc=control_nc, control_classes=control_classes)
    elif model_type == 'ms_ssim_l1_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim_l1')
    elif model_type == 'ssim_l1_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1')
    elif model_type == 'ssim_l1_squirrel_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1', lr_nc=lr_nc, lr_scale=lr_scale, use_squirrel=True, lr_loss_mode=lr_loss_mode, squirrel_weight=squirrel_weight)
    elif model_type == 'ms_ssim_l1_squirrel_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim_l1', lr_nc=lr_nc, lr_scale=lr_scale, use_squirrel=True, lr_loss_mode=lr_loss_mode, squirrel_weight=squirrel_weight)
    elif model_type == 'ssim_l1_lr_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1', lr_nc=1, lr_scale=lr_scale)
    elif model_type == 'ssim_l1_punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1', use_punet=True, control_nc=control_nc, control_classes=control_classes)
    elif model_type == 'ssim_l1_squirrel_punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1', use_punet=True, control_nc=control_nc, control_classes=control_classes, lr_nc=lr_nc, lr_scale=lr_scale, use_squirrel=True, lr_loss_mode=lr_loss_mode, squirrel_weight=squirrel_weight)
    elif model_type == 'ms_ssim_l1_squirrel_punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim_l1', use_punet=True, control_nc=control_nc, control_classes=control_classes, lr_nc=lr_nc, lr_scale=lr_scale, use_squirrel=True, lr_loss_mode=lr_loss_mode, squirrel_weight=squirrel_weight)
    elif model_type == 'ssim_l1_fpp_punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1_fpp', use_punet=True, control_nc=control_nc, control_classes=control_classes)
    elif model_type == 'io_ssim_punet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='io_ssim', use_punet=True, control_nc=control_nc, control_classes=control_classes)
    elif model_type == 'io_ssim_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='io_ssim')
    elif model_type == 'ms_ssim_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim')
    elif model_type == 'bayesian_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, output_uncertainty=True, bayesian_dropout=True, dropout_prob=dropout_prob, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv)
    elif model_type == 'bayesian_ssim_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, output_uncertainty=True, dropout_prob=dropout_prob, bayesian_dropout=True, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim=True)
    elif model_type == 'bayesian_ssim_l1_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, output_uncertainty=True, dropout_prob=dropout_prob, bayesian_dropout=True, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1')
    elif model_type == 'bayesian_ms_ssim_unet':
        model = create_unet_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, output_uncertainty=True, dropout_prob=dropout_prob, bayesian_dropout=True, use_resize_conv=use_resize_conv, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim')
    elif model_type == 'pix2pix':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_gaussd=use_gaussd)
    elif model_type == 'ssim_pix2pix':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim=True, use_gaussd=use_gaussd)
    elif model_type == 'ms_ssim_pix2pix':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim', use_gaussd=use_gaussd)
    elif model_type == 'ms_ssim_l1_pix2pix':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ms_ssim_l1', use_gaussd=use_gaussd)
    elif model_type == 'ssim_l1_pix2pix':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, bayesian_dropout=False, use_resize_conv=use_resize_conv, gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim='ssim_l1', use_gaussd=use_gaussd)
        ...
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, output_uncertainty=True, bayesian_dropout=True, dropout_prob=dropout_prob, use_resize_conv=use_resize_conv,  gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_gaussd=use_gaussd)
    elif model_type == 'bayesian_ssim_pix2pix':
        model = create_pix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, output_uncertainty=True, bayesian_dropout=True, dropout_prob=dropout_prob, use_resize_conv=use_resize_conv,  gan_weight=gan_weight, l1_weight=l1_weight, lr=lr, beta1=beta1, lambda_tv=lambda_tv, use_ssim=True, use_gaussd=use_gaussd)
    ...
    #     model = create_pix2pix2_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob, use_resize_conv=use_resize_conv)
    # elif model_type == 'fpix2pix':
    #     model = create_fpix2pix_model(inputs_batch, targets_batch, control_batch, channel_mask_batch, dropout_prob=dropout_prob)
    else:
